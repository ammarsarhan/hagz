    ...
    return (
        <div className="lg:sticky top-24 h-fit w-full rounded-2xl p-5 mb-8 bg-gray-100">
            <form className="flex flex-col gap-y-6">
                <div className="flex flex-col gap-y-6 w-full rounded-xl bg-white p-5 text-sm">
                ...
                <div className="flex flex-col gap-y-4 rounded-2xl bg-white p-5 text-sm sm:text-base">
