...
import { createOwner, OwnerPayloadType } from "@/app/utils/api/client";
...
export default function Form() {    
    ...
    const mutation = useMutation({
        mutationKey: ['auth'],
        mutationFn: (payload: OwnerPayloadType) => createOwner(payload),
        onError: (error) => {
        ...
        <div className="h-screen grid grid-cols-2 gap-x-4 p-4">
            <div className="relative flex flex-col items-center justify-center gap-y-8">
                <div className="flex flex-col gap-y-0.5 text-center">
                    <h1 className="text-xl font-medium">Sign Up As An Owner</h1>
                    <p className="text-gray-500 text-[0.8125rem] w-96">Create an account as an owner to create and manage your pitches.</p>
                </div>
