...
export default function Completed () {
    ...
    return (
        <>
            <Breadcrumbs labels={[{label: "Reservations", href: "/dashboard/reservations"}, {label: "Completed", href: "/dashboard/reservations/completed"}]} className="mt-4"/>
            <div className='flex flex-col pt-4'>
                <span className='font-semibold text-xl block'>Completed</span>
                <div className="mt-2">
                    <ViewSwitch 
                        active={activeView} 
