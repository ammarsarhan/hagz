...
export const ERROR_CODES = {
  ...
  USER_SESSION_CONFLICT: "USER_SESSION_CONFLICT",
  USER_NOT_ACTIVE: "USER_NOT_ACTIVE",
  USER_PREFERENCES_NOT_FOUND: "USER_PREFERENCES_NOT_FOUND",
  USER_AVATAR_NOT_FOUND: "USER_AVATAR_NOT_FOUND",
  USER_AVATAR_CONFIRMATION_FAILED: "USER_AVATAR_CONFIRMATION_FAILED",
  PROFILE_ACCESS_FORBIDDEN: "PROFILE_ACCESS_FORBIDDEN",
  
  // Maps
  GOOGLE_MAPS_LINK_INVALID: "GOOGLE_MAPS_LINK_INVALID",
  ...
  // Ledger & Payout
  PAYOUT_ACTIVE_EXISTS: "PAYOUT_ACTIVE_EXISTS",
  PAYOUT_NOT_FOUND: "PAYOUT_NOT_FOUND",
  PAYOUT_INVALID_AMOUNT: "PAYOUT_INVALID_AMOUNT",
  LEDGER_ENTRY_NOT_FOUND: "LEDGER_ENTRY_NOT_FOUND",
  LEDGER_ENTRY_MISMATCH: "LEDGER_ENTRY_MISMATCH",
  LEDGER_ENTRY_LINKED_TO_PAYOUT: "LEDGER_ENTRY_LINKED_TO_PAYOUT"
} as const;
