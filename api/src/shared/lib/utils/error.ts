...
export const ERROR_CODES = {
  ...
  PITCH_NOT_EDITABLE: "PITCH_NOT_EDITABLE",
  ...
  PITCH_AMENITY_REQUIRED: "PITCH_AMENITY_REQUIRED",
  ...
  PITCH_GROUND_REQUIRED: "PITCH_GROUND_REQUIRED",
  PITCH_MEDIA_MINIMUM_REQUIRED: "PITCH_MEDIA_MINIMUM_REQUIRED",
  PITCH_MEDIA_LIMIT_EXCEEDED: "PITCH_MEDIA_LIMIT_EXCEEDED",
  ...
  GROUND_BOOKINGS_CONFLICT: "GROUND_BOOKINGS_CONFLICT",
  GROUND_TRANSITION_INVALID: "GROUND_TRANSITION_INVALID",
