...
const sportNames = Object.keys(sportMap) as GroundDraftType["sport"][];

type GroundModalProps = {
    visible: boolean;
    initialValue?: GroundDraftType;
    onClose: () => void;
    onSave: (ground: GroundDraftType) => void;
    onRemove?: () => void;
};
                ...
                >
                    ...
                    <View className="gap-y-2 py-2 mb-6">
                        ...
                        <Text className="text-gray-500">
                            {isEdit ? "Update your ground details, settings, schedule, and pricing whenever you need." : "Add your ground details and set up your schedule and pricing."}
                        </Text>
                    </View>
                    <View className="flex-1 gap-y-12">
                            ...
                            <View className="flex-row flex-wrap gap-2">
                                {
                                    sportNames.map((sport) => (
                                        <GroundPill
                                            ...
                                            onPress={() => dispatch({ type: "SET_SPORT", sport })}
                                        />
                                    ))
                                }
                            </View>
                        ...
                        <Input
                            ...
                            value={form.name}
                            onChangeText={(value: string) => setField("name", value)}
                        />
                        <Input
                            ...
                            onChangeText={(value: string) => setField("description", value || undefined)}
                        />
                        <View className="gap-y-2">
                        ...
                        <Input
                            ...
                            onChangeText={(value: string) => setField("basePrice", Number(value) || 0)}
                        />
                        <Input
                            ...
                            onChangeText={(value: string) => setField("peakPrice", value ? Number(value) : undefined)}
                        />
                        <Input
                            ...
                            onChangeText={(value: string) => setField("discountPrice", value ? Number(value) : undefined)}
                        />
                    </View>
                </KeyboardAwareScrollView>
