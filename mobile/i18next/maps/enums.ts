...
export const getDisplayRecurringPayment = (k: string) =>
  getDisplay(recurringPaymentScheduleTranslations, k);
...
export const getDisplayInvitationStatus = (k: string) =>
  getDisplay(invitationStatusTranslations, k);
